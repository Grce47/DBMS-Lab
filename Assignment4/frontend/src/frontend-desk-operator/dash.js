    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      function discharge(id){
        fetch(process.env.REACT_APP_BACKEND_URL.concat('api/delete_patient/'), {
            ...
            if(data.hasOwnProperty('Success')){
                setPatientData({patients: patientData.patients.filter((patient) => patient.id !== id)});
            }else{
                alert(data.Error);
            }
        })
      ...
      function admit_patient(id){
        fetch(process.env.REACT_APP_BACKEND_URL.concat('api/admit_patient/'), {
            ...
            if(data.hasOwnProperty("Success")){
                setPatientData({patients: patientData.patients.filter((patient) => {
                    if(patient.id == id){
        ...
        <div className="app-container clicker">
          <div className="app-header">
            ...
            <div className="app-header-right">
              ...
              <PatientRegistration patientData = {patientData} setPatientData = {setPatientData}/>
